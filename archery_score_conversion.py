...
def main():
    ...
    parser.add_argument('--tolerance', type=float, help='Tolerance when searching for the best fit standard deviation for the given score. Larger numbers are faster but less accurate. Default: 3', default=3.0)
    parser.add_argument('--trials', type=int, help='How many times to run the best fit standard deviation search for the given score. Larger numbers are slower but more accurate. Default: 100', default=100)
    parser.add_argument('--num_shots', type=int, help='How many shots to take at the new range and target size to determine the hit rate. Larger numbers are slower but more accurate. Default: 10000', default=10000)
    ...
    print('Hit percent: %s' % hit_rate)
    print('%s/20' % int(hit_rate_twenty))
